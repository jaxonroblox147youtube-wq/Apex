...
async def hack(interaction: discord.Interaction, member: discord.Member = None):
    ...
    phases = [
        ...
        "Searching for boy friends and girl friends on discord and enbarssing them with their messages...",
        "accessing private messages...",
        "Searching for nudes...",
        "Searching for IP address...",
        "Searching for location...",
        "Searching for credit card info...",
        "Buying stuff with credit card info...",
        "Searching for bank account info...",
        "Buying Kidnappers to kidnap...",
        "Pinging IP...",
        "Bypassing firewall...",
        "Downloading data...",
        "Decrypting files...",
